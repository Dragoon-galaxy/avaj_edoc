...
Practical No. :- 8 
Q.8] Consider student data consist of fields such as roll number, name, and marks of various subjects. Write a 
...
class Student { 
 ...
 String name; 
 int[] marks; 
 Student(int rollNumber, String name, int ...marks) throws 
 IncorrectRollNumberException, NameTooShortException, 
